...
def gpio_map(styles):
    ...
    data = [
        ...
        ["GPIO 26", "HC-SR04 ECHO", "Ultrasonic", "USED (via divider)", "FREE"],
        ["GPIO 25", "HC-SR04 TRIG", "Ultrasonic", "USED", "FREE"],
        ["GPIO 24", "IN2 (Left Backward)", "L298N Motors", "Same", "Same"],
...
def appendix(styles):
    ...
    pi_pins = [
        ...
        ["Pin 18", "GPIO 24", "L298N IN2 (left bwd)", "Motors"],
        ["Pin 15", "GPIO 22", "L298N IN3 (right fwd)", "Motors"],
        ["Pin 16", "GPIO 23", "L298N IN4 (right bwd)", "Motors"],
        ["Pin 37", "GPIO 26", "HC-SR04 ECHO (Path A only)", "Ultrasonic"],
